...
class FastFoodAndTerminalController extends Controller
{
    protected $cmsService;
    public $page = "fastfood";
    public $section = "main_content";
    public $uploadPath = 'cms/fastfood';
    ...
    public function index(Request $request) {
        ...
        return view('backend.layouts.cms.fastFood.index', compact('data', 'type'));
    }
    ...
    public function content(Request $request) {
        try {
            ...
            $fileFields = ['sec1_video', 'sec2_video', 'sec3_image','sec4_image', 'sec5_video'];
            $metadata_files = [];
            ...
            CMS::updateOrCreate(
                ...
                ['metadata' => $metadata, 'status' => 'active', 'slug' => 'fastfood-' . $type]
            );

            Cache::forget('cms');
            return redirect()->back()->with('t-success', 'Fast Food And Terminal content updated successfully.');
        } catch (Exception $e) {
