...
class GovermentController extends Controller
{
    ...
    public $page = "goverment";
    public $section = "main_content";
    public $uploadPath = 'cms/goverment';
    ...
    public function index(Request $request) {
        ...
        return view('backend.layouts.cms.goverment.index', compact('data', 'type'));
    }
    ...
    public function content(Request $request) {
        try {
            ...
            CMS::updateOrCreate(
                ...
                ['metadata' => $metadata, 'status' => 'active', 'slug' => 'goverment-' . $type]
            );

            Cache::forget('cms');
            return redirect()->back()->with('t-success', 'Goverment Content update sucessfuly.');
        } catch (Exception $e) {
