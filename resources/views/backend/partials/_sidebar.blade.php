    ...
    <div class="app-sidebar" style="overflow: scroll">
        ...
        <div class="main-sidemenu">
            <ul class="side-menu mt-2">
                ...
                {{-- cmsss sectionn    --}}
                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('admin.cms.legal.form') && request('section') == 'privacy_policy' ? 'has-link active' : '' }}"
                        href="{{ route('admin.cms.legal.form', 'privacy_policy') }}">
                        <i class="fa-solid fa-file-contract side-menu__icon"></i>
...
{{--
                ...
                @role('admin')
                    <li class="slide">
                        <a class="side-menu__item {{ request()->routeIs('admin.subcategory.*') ? 'has-link active' : '' }}"
                ...
                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('admin.course.*') ? 'has-link active' : '' }}"
                ...
                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('admin.cms.home.announcement*') ? 'has-link active' : '' }}"
                        href="{{ route('admin.cms.home.announcement.index') }}">
                        <i class="fa-solid fa-bullhorn side-menu__icon"></i>
                        <span class="side-menu__label"> Award Announcement</span>
                    </a>
                </li>
                ...
                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('admin.attribute.*') ? 'has-link active' : '' }}"
                ...
                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('admin.booking.*') ? 'has-link active' : '' }}"
                ...
                @role('admin')
                    <li class="slide">
                        <a class="side-menu__item {{ request()->routeIs('admin.type.*') ? 'has-link active' : '' }}"
                ...
                @endrole
                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('admin.project.*') ? 'has-link active' : '' }}"
                ...
                {{-- @role('admin')
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            <li><a href="{{ route('admin.template.email.index') }}" class="slide-item">Email Template</a>
                            </li>
                        </ul>
                    </li>
                @endrole --}}
                @role('admin')
                    ...
                    <li class="slide">
                        <a class="side-menu__item {{ request()->routeIs('admin.cms.home.trust_form.*') ? 'has-link active' : '' }}"
                            href="{{ route('admin.cms.home.trust_form.index') }}">
                            <i class="fa-solid fa-list-check side-menu__icon"></i>
                            <span class="side-menu__label">Trust Form Options</span>
                        </a>
                    </li>
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            <li class="sub-slide {{ request()->routeIs('admin.cms.home.*') ? 'is-expanded' : '' }}">
                                <a class="sub-side-menu__item {{ request()->routeIs('admin.cms.home.*') ? 'active' : '' }}"
                                    data-bs-toggle="sub-slide" href="#">
                                    <span class="sub-side-menu__label">Home Page</span>
                        ...
                        <ul class="slide-menu">
                            ...
                            <li>
                                <a href="{{ route('admin.cms.home.emailandtextai.index') }}"
                                    class="sub-slide-item {{ request()->routeIs('admin.cms.home.emailandtextai.index') ? 'active' : '' }}">
                                    Email Text AI and Response
                                </a>
                            </li>
                        </ul>
                        ...
                        <ul class="slide-menu">
                            ...
                            <li>
                                <a href="{{ route('admin.cms.home.drive_thruai.index') }}"
                                    class="sub-slide-item {{ request()->routeIs('admin.cms.home.drive_thruai.index') ? 'active' : '' }}">
                                    Drive Thru AI
                                </a>
                            </li>
                        </ul>
                        <ul class="slide-menu">
                            ...
                            <li>
                                <a href="{{ route('admin.cms.home.aboutus.index') }}"
                                    class="sub-slide-item {{ request()->routeIs('admin.cms.home.aboutus.index') ? 'active' : '' }}">
                                    About us
                                </a>
                            </li>
                        </ul>
                        ...
                        <ul class="slide-menu">
                            ...
                            <li>
                                <a href="{{ route('admin.cms.home.trust.index') }}"
                                    class="sub-slide-item {{ request()->routeIs('admin.cms.home.trust.index') ? 'active' : '' }}">
                                    Trust Pge
                                </a>
                            </li>
                        </ul>
