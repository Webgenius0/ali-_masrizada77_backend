        ...
        <div class="side-app">
            <div class="main-container container-fluid">
                <div class="page-header">
                    <h1 class="page-title">Fast Food and Terminals</h1>
                    <div class="ms-auto">
                        <a href="?type=english"
                ...
                <form action="{{ route('admin.cms.home.fastfood.content') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h3 class="card-title">Section 3: Smart Patient Communication</h3>
                    ...
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h3 class="card-title">Section 4: Incereas Your Company </h3>
...
<div class="col-md-6">
                <label class="form-label">Side Main Image</label>
                <input type="file" name="sec4_image" class="form-control mb-2" accept="image/*" onchange="previewImage(this, 'sec4_img_prev')">
                <img id="sec4_img_prev" src="{{ (isset($data->metadata['sec4_image']) && $data->metadata['sec4_image']) ? asset($data->metadata['sec4_image']) : asset('backend/images/no-image.png') }}" class="img-thumbnail" style="max-width:150px;">
            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="card mb-4">
                                <div class="card-header bg-secondary text-white">
                                    <h3 class="card-title">Section 5: Design For Make </h3>
                                </div>
                                <div class="card-body">
