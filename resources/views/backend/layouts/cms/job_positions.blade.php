    ...
    <div class="side-app">
        <div class="main-container container-fluid">
            <div class="page-header">
                <h1 class="page-title">Job Position Options ({{ ucfirst($type) }})</h1>
                <div class="ms-auto">
            ...
            <form action="{{ route('admin.cms.job_position.update') }}" method="POST">
                @csrf
                <input type="hidden" name="type" value="{{ $type }}">

                <div class="card shadow-sm mb-4">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <h3 class="card-title">Positions You Are Applying For (Dropdown Options)</h3>
                        ...
                        <div id="options-wrapper">
                                ...
                                @foreach ($options as $key => $option)
                                    <div class="border p-3 mb-3 item-box position-relative">
                                        <div class="row align-items-center">
                                            <div class="col-md-10">
                                                <input type="text" name="options[]" class="form-control" value="{{ $option }}" placeholder="Enter position name">
                                            </div>
                            ...
                            @else
                                ...
                                <div class="border p-3 mb-3 item-box position-relative">
                                    <div class="row align-items-center">
                                        <div class="col-md-10">
                                            <input type="text" name="options[]" class="form-control" placeholder="Enter position name">
                                        </div>
                                        <div class="col-md-2 text-center">
                                            <button type="button" class="btn btn-danger btn-sm remove-item">×</button>
                                        </div>
                ...
                <div class="card-footer text-center py-4 bg-light shadow-sm">
                    <button type="submit" class="btn btn-success btn-lg px-5">SAVE POSITION OPTIONS</button>
                </div>
            </form>
        </div>
    </div>
