...
@section('content')
    ...
    <style>
        .image-preview-wrapper {
            position: relative;
            width: 100px;
            /* আইকনের মাপ অনুযায়ী অ্যাডজাস্ট করুন */
            height: 100px;
            margin: 10px auto;
            border: 1px solid #ddd;
            border-radius: 4px;
            overflow: hidden;
            /* চেকারবোর্ড ব্যাকগ্রাউন্ড প্যাটার্ন */
        ...
        /* সাইড ইমেজের জন্য আলাদা স্টাইল (বড় মাপ) */
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        @for ($i = 0; $i < 3; $i++)
                                            <div class="col-4">
                                                {{-- টাইপ 'number' করা হয়েছে এবং 'step' ব্যবহার করা হয়েছে যাতে ডেসিমেল সাপোর্ট করে --}}
