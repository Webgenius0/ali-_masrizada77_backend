    ...
    public function run(): void
    {
        if (app()->environment('local')) {
            ...
            DB::table('roles')->insert([
                ...
                ['id' => 3, 'name' => 'user', 'slug' => 'user', 'guard_name' => 'api'],
            ]);
            ...
            DB::table('users')->insert([
                ...
                ['id' => 3, 'name' => 'User', 'slug' => 'user', 'email' => 'user@user.com', 'password' => Hash::make('12345678'), 'stripe_account_id' => 'acct_1RHGjbQPESrwz7hv', 'otp_verified_at' => now(), 'is_owner' => '0'],
                 ['id' => 4, 'name' => 'User1', 'slug' => 'user1', 'email' => 'user1@user.com', 'password' => Hash::make('12345678'), 'stripe_account_id' => 'acct_1RHGjbQPESrwz7hv', 'otp_verified_at' => now(), 'is_owner' => '0'],
